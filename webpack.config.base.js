...
module.exports = {
    ...
    entry: {
        ...
        reactions: './src/js/pages/galleries/reactions.js',
        entertainment: './src/js/pages/galleries/entertainment.js',
        sports: './src/js/pages/galleries/sports.js',
        artists: './src/js/pages/galleries/artists.js',
        stickers: './src/js/pages/galleries/stickers.js',
        item: './src/js/pages/item.js',
    },
    output: {
        filename: 'js/[name].js',
